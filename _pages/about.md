...
2.  **不放养**：会手把手指导你发表第一篇顶会！绝对不放养。也欢迎和支持有独立能力成员开展独立研究，绝不瞎指导。对有志于深造的同学的authorship，优先一作。
2.  **学术奖励**：达成顶级成果有奖励，并且逐年提高奖励金额。
3.  **硬核**：从底层算法架构设计到具体的医疗/安全应用，既有理论深度，又有应用广度。
4.  **有趣**：与其做一个无情的调参机器，不如来做保护隐私的黑客克星，或者辅助医生的 AI 专家，或者智能体的构建者！
